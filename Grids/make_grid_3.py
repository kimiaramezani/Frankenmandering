...
class Graph:
    ...
    def render_layers(self,*,show_geo: bool = True,show_social: bool = True,show_districts: bool = True,show_nodes: bool = True,
                  # visual knobs
                  node_size: float = 36.0,geo_lw: float = 1.5,soc_lw: float = 0.9,geo_alpha: float = 0.9,soc_alpha: float = 0.7,
                  # Z spacing knobs
                  ...
                  figsize=(7, 6),elev: float = 30,azim: float = -50,return_rgb: bool = False):
        """
        3D multilayer view:
